...
![LinkedIn][1] [![Google+][2]](https://www.youtube.com/c/groupdocs?utm_source=nl&utm_medium=link&utm_campaign=nl-jan2020) [![Twitter][3]](https://twitter.com/GroupDocs?utm_source=nl&utm_medium=link&utm_campaign=nl-jan2020) [![Facebook][4]](https://www.facebook.com/GroupDocs?utm_source=nl&utm_medium=link&utm_campaign=nl-jan2020)
...
[![25% off Conholdate.Total][6].png "25% off Conholdate.Total")](https://purchase.groupdocs.com/?utm_source=nl&utm_medium=link&utm_campaign=nl-jan2020)

_Hurry! Offer ends January 31st._  

Get 25% off GroupDocs.Total for .NET and Java. Quote [**HOLOFF2019**][7] when placing your order.

[![Buy Now][8]](https://purchase.groupdocs.com/?utm_source=nl&utm_medium=link&utm_campaign=nl-jan2020)
...
Using GroupDocs.Conversion for .NET, you can now monitor document conversion progress. The document converter listener implementation is used for monitoring conversion status and progress. [Read more details here][13].
...
We have a major update for our customers who are using our metadata manipulation API – GroupDocs.Metadata for .NET. We have revamped the architecture of the API to improve and simplify the process of reading, updating, searching or removing the metadata properties from the documents. Please [visit this article][15] to get an insight.
